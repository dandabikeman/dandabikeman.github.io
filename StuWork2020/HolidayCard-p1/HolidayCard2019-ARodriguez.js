...
p.nominalBounds = new cjs.Rectangle(-180.4,-167.2,364.5,387.7);
...
(lib.Owl = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_5}]},4).to({state:[{t:this.instance_6}]},5).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_4}]},6).to({state:[{t:this.instance_5}]},4).to({state:[{t:this.instance_6}]},5).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_4}]},5).to({state:[{t:this.instance_5}]},4).to({state:[{t:this.instance_6}]},5).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_11}]},6).wait(16));
...
p.nominalBounds = new cjs.Rectangle(-210.9,2.5,108.80000000000001,126.6);
...
// stage content:
(lib.HolidayCard2019ARodriguez = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text_1 = new cjs.Text("Happy Holidays!", "144px 'Times New Roman'");
	this.text_1.lineHeight = 161;
	this.text_1.lineWidth = 1004;
	this.text_1.parent = this;
	this.text_1.setTransform(68.4,33.45);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(790.4,804.45,2.4788,2.4788,0,0,0,-156.6,65.8);

	this.instance_2 = new lib.Snowman();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1190.05,553.45,2.104,2.104,0,0,0,1.9,26.6);
...
p.nominalBounds = new cjs.Rectangle(906.4,556.5,773.6,493.5);
// library properties:
lib.properties = {
