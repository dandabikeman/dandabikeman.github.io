...
lib.ssMetadata = [
		{name:"HolidayCard2019_ASalas_atlas_", frames: [[0,0,1231,960],[1233,0,554,1026],[508,962,506,206],[1016,1028,506,206],[0,962,506,206]]}
];
...
(lib.CachedTexturedBitmap_446 = function() {
	this.initialize(ss["HolidayCard2019_ASalas_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.HolidayCard2019ASalas = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(923.65,557.65,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text,p:{x:1592.65,y:960.35,text:"1",font:"48px 'Times New Roman'",lineHeight:55.15,lineWidth:67}}]}).to({state:[]},1).to({state:[{t:this.text,p:{x:338.05,y:129.05,text:"Holiday Message",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1004}}]},38).to({state:[{t:this.instance},{t:this.text_1},{t:this.text,p:{x:324.05,y:112,text:"merry christmas",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1000}}]},10).wait(1));

	// Animation
	this.instance_1 = new lib.CachedTexturedBitmap_447();
	this.instance_1.parent = this;
	this.instance_1.setTransform(467.65,516.8,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(938.5,635,723.2,402.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_ASalas_atlas_.png?1576700238771", id:"HolidayCard2019_ASalas_atlas_"}
	],
	preloads: []
};
