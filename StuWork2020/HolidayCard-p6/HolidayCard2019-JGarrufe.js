...
lib.ssMetadata = [
		{name:"HolidayCard2019_JGarrufe_atlas_", frames: [[0,0,506,206],[0,416,506,206],[0,208,506,206]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2133,1516);
...
(lib.CachedTexturedBitmap_25 = function() {
	this.initialize(ss["HolidayCard2019_JGarrufe_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.HolidayCard2019JGarrufe = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({x:475.35,y:222.25,text:"Happy Christmas",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1008},0).wait(38).to({x:509.75,y:162.4,lineWidth:1025},0).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_22();
	this.instance.parent = this;
	this.instance.setTransform(145.45,103.8,0.5,0.5);

	this.instance_1 = new lib.CachedTexturedBitmap_23();
	this.instance_1.parent = this;
	this.instance_1.setTransform(145.45,103.8,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_24();
	this.instance_2.parent = this;
	this.instance_2.setTransform(145.45,103.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},2).to({state:[{t:this.instance_2}]},3).wait(45));
...
p.nominalBounds = new cjs.Rectangle(938.5,628.8,723.2,400.60000000000014);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_22.png?1576614729755", id:"CachedTexturedBitmap_22"},
		{src:"images/CachedTexturedBitmap_23.png?1576614729755", id:"CachedTexturedBitmap_23"},
		{src:"images/CachedTexturedBitmap_24.png?1576614729755", id:"CachedTexturedBitmap_24"},
		{src:"images/HolidayCard2019_JGarrufe_atlas_.png?1576614729746", id:"HolidayCard2019_JGarrufe_atlas_"}
	],
	preloads: []
};
