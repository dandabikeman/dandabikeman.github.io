...
lib.ssMetadata = [
		{name:"HolidayCard2019_SGonzalez_atlas_", frames: [[0,208,506,206],[0,416,506,206],[0,0,506,206]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,3403,2044);


(lib.CachedTexturedBitmap_526 = function() {
	this.initialize(ss["HolidayCard2019_SGonzalez_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.CachedTexturedBitmap_527();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_528();
...
// stage content:
(lib.HolidayCard2019SGonzalez = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:338.05,y:129.05,text:"Merry Christmas",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1004},0).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_525();
	this.instance.parent = this;
	this.instance.setTransform(-16.85,30.75,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(823.2,555.8,861.5,497);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_525.png?1576701143256", id:"CachedTexturedBitmap_525"},
		{src:"images/HolidayCard2019_SGonzalez_atlas_.png?1576701143247", id:"HolidayCard2019_SGonzalez_atlas_"}
	],
	preloads: []
};
