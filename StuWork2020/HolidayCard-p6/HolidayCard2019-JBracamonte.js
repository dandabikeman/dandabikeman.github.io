...
lib.ssMetadata = [
		{name:"HolidayCard2019_JBracamonte_atlas_", frames: [[821,0,680,1024],[0,0,819,964],[1503,0,506,206],[1503,208,506,206],[1503,416,506,206]]}
];
...
(lib.CachedTexturedBitmap_520 = function() {
	this.initialize(ss["HolidayCard2019_JBracamonte_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.CachedTexturedBitmap_524();
...
// stage content:
(lib.HolidayCard2019JBracamonte = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(1029.4,363.65,0.5,0.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(215.15,318.2,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_JBracamonte_atlas_.png?1576701077938", id:"HolidayCard2019_JBracamonte_atlas_"}
	],
	preloads: []
};
