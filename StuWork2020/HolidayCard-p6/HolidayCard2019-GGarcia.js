...
lib.ssMetadata = [
		{name:"HolidayCard2019_GGarcia_atlas_", frames: [[0,0,949,911],[0,913,506,206],[508,913,506,206],[0,1121,506,206]]}
];
...
(lib.CachedTexturedBitmap_499 = function() {
	this.initialize(ss["HolidayCard2019_GGarcia_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.HolidayCard2019GGarcia = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:352,y:129.05,text:"Merry Christmas",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1012},0).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_499();
	this.instance.parent = this;
	this.instance.setTransform(907.25,469.7,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_GGarcia_atlas_.png?1576700703566", id:"HolidayCard2019_GGarcia_atlas_"}
	],
	preloads: []
};
