...
lib.ssMetadata = [
		{name:"HolidayCard2019_GRuiz_atlas_", frames: [[0,1240,1190,554],[0,0,1226,618],[0,620,1226,618]]},
		{name:"HolidayCard2019_GRuiz_atlas_2", frames: [[951,0,608,929],[508,931,506,206],[0,894,506,206],[0,686,506,206],[1016,1133,608,105],[508,838,201,48],[508,686,263,150],[0,0,949,684],[1561,818,455,313],[1626,1133,239,248],[711,865,74,35],[773,686,158,177],[1561,0,474,816]]}
];
...
(lib.CachedTexturedBitmap_503 = function() {
	this.initialize(ss["HolidayCard2019_GRuiz_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedTexturedBitmap_514 = function() {
	this.initialize(ss["HolidayCard2019_GRuiz_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Snowman = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-157.3,-93.15,0.5,0.5);
	...
	this.instance_1.setTransform(-53.1,-93.2,0.5,0.5);
	...
	this.instance_2.setTransform(-65.55,-258.95,0.5,0.5);

	this.instance_3 = new lib.CachedTexturedBitmap_511();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-316.05,-264.85,0.5,0.5);

	this.instance_4 = new lib.CachedTexturedBitmap_513();
	this.instance_4.parent = this;
	this.instance_4.setTransform(118.4,-249.35,0.5,0.5);

	this.instance_5 = new lib.CachedTexturedBitmap_512();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-356.85,-128.9,0.5,0.5);

	this.instance_6 = new lib.CachedTexturedBitmap_514();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-356.85,-249.4,0.5,0.5);

	this.instance_7 = new lib.CachedTexturedBitmap_515();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-340,-267.8,0.5,0.5);

	this.instance_8 = new lib.CachedTexturedBitmap_516();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-340,-267.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_5},{t:this.instance_4}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).wait(1));

	// Nose
	this.instance_9 = new lib.CachedTexturedBitmap_517();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-12,-138.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(8));

	// eyes
	this.instance_10 = new lib.CachedTexturedBitmap_518();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-43,-174.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(8));

	// Body
	this.instance_11 = new lib.CachedTexturedBitmap_519();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-125.5,-202.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(8));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-356.8,-267.8,629.8,473.3);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.CachedTexturedBitmap_506();
	this.instance_2.parent = this;
...
// stage content:
(lib.HolidayCard2019GRuiz = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:338.05,y:129.05,text:"Happy Holidays",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1004},0).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_503();
	this.instance.parent = this;
	this.instance.setTransform(944.4,429.95,0.5,0.5);

	this.instance_1 = new lib.Snowman();
	this.instance_1.parent = this;
	this.instance_1.setTransform(1096.3,662.1,1,1,0,0,0,-5.4,-26.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(49));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_GRuiz_atlas_.png?1576700785667", id:"HolidayCard2019_GRuiz_atlas_"},
		{src:"images/HolidayCard2019_GRuiz_atlas_2.png?1576700785667", id:"HolidayCard2019_GRuiz_atlas_2"}
	],
	preloads: []
};
