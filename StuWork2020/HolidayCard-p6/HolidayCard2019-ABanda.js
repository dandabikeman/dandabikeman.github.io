...
lib.ssMetadata = [
		{name:"HolidayCard2019_ABanda_atlas_", frames: [[0,0,1576,859],[0,861,1576,859]]},
		{name:"HolidayCard2019_ABanda_atlas_2", frames: [[0,0,1639,781],[0,783,1650,775]]},
		{name:"HolidayCard2019_ABanda_atlas_3", frames: [[0,0,1302,888],[0,890,1206,933],[1016,1825,506,206],[508,1825,506,206],[0,1825,506,206],[1208,890,112,112]]}
];
...
(lib.CachedTexturedBitmap_10 = function() {
	this.initialize(ss["HolidayCard2019_ABanda_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedTexturedBitmap_12 = function() {
	this.initialize(ss["HolidayCard2019_ABanda_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
p.nominalBounds = new cjs.Rectangle(0,0,2594,944);
...
(lib.CachedTexturedBitmap_8 = function() {
	this.initialize(ss["HolidayCard2019_ABanda_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.HolidayCard2019ABanda = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// sound
	this.text = new cjs.Text("", "144px '_serif'", "#FFFFFF");
	this.text.lineHeight = 161;
	this.text.lineWidth = 100;
	this.text.parent = this;
	this.text.setTransform(1231.55,-588.1);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(39).to({_off:false},0).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.text_1).to({_off:true},1).wait(38).to({_off:false,x:338.05,y:129.05,text:"Merry Christmas!",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1057},0).wait(11));

	// eyes
	this.instance = new lib.CachedTexturedBitmap_6();
	this.instance.parent = this;
	this.instance.setTransform(557.95,535.55,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({x:585.95,y:606.8},0).wait(5).to({y:617.3},0).wait(1).to({y:560.85},0).wait(3).to({y:569.9},0).wait(32));

	// head
	this.instance_1 = new lib.CachedTexturedBitmap_7();
	this.instance_1.parent = this;
	this.instance_1.setTransform(439.95,290.85,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_8();
	this.instance_2.parent = this;
	this.instance_2.setTransform(473.15,323.8,0.5,0.5);

	this.instance_3 = new lib.CachedTexturedBitmap_9();
	this.instance_3.parent = this;
	this.instance_3.setTransform(473.15,323.8,0.5,0.5);

	this.instance_4 = new lib.CachedTexturedBitmap_10();
	this.instance_4.parent = this;
	this.instance_4.setTransform(441.75,323.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},9).to({state:[{t:this.instance_3}]},3).to({state:[{t:this.instance_4}]},3).wait(35));

	// Animation
	this.instance_5 = new lib.CachedTexturedBitmap_17();
	this.instance_5.parent = this;
	this.instance_5.setTransform(20,381.35,0.5,0.5);
	...
	this.instance_6.setTransform(749.15,558.45,0.5,0.5);

	this.instance_7 = new lib.CachedTexturedBitmap_13();
	this.instance_7.parent = this;
	this.instance_7.setTransform(797.15,535.95,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(860,-65.1,801.7,1094.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_17.png?1576612630092", id:"CachedTexturedBitmap_17"},
		{src:"images/HolidayCard2019_ABanda_atlas_.png?1576612630077", id:"HolidayCard2019_ABanda_atlas_"},
		{src:"images/HolidayCard2019_ABanda_atlas_2.png?1576612630077", id:"HolidayCard2019_ABanda_atlas_2"},
		{src:"images/HolidayCard2019_ABanda_atlas_3.png?1576612630078", id:"HolidayCard2019_ABanda_atlas_3"},
		{src:"sounds/HappyHolidayswav.mp3?1576612630092", id:"HappyHolidayswav"}
	],
	preloads: []
};
