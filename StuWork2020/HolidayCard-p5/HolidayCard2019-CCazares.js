...
lib.ssMetadata = [
		{name:"HolidayCard2019_CCazares_atlas_", frames: [[0,0,1115,1270],[1117,0,506,206],[1117,208,506,206],[1117,416,506,206]]}
];
...
(lib.CachedTexturedBitmap_616 = function() {
	this.initialize(ss["HolidayCard2019_CCazares_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.CachedTexturedBitmap_618();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_619();
...
// stage content:
(lib.HolidayCard2019CCazares = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text_1 = new cjs.Text("Merry Christmas", "144px 'Times New Roman'", "#FF00FF");
	this.text_1.lineHeight = 161;
	this.text_1.lineWidth = 999;
	this.text_1.parent = this;
	this.text_1.setTransform(407.6,-15.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text,p:{x:1592.65,y:960.35,text:"1",font:"48px 'Times New Roman'",color:"#000000",lineHeight:55.15,lineWidth:67}}]}).to({state:[]},1).to({state:[{t:this.text_1},{t:this.text,p:{x:399.15,y:-19.45,text:"Merry Christmas",font:"144px 'Times New Roman'",color:"#00FFFF",lineHeight:161.45,lineWidth:999}}]},38).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_616();
	this.instance.parent = this;
	this.instance.setTransform(583.35,-0.45,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(938.5,503.6,723.2,525.8000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_CCazares_atlas_.png?1576634597165", id:"HolidayCard2019_CCazares_atlas_"},
		{src:"sounds/Jackpotwav.mp3?1576634597175", id:"Jackpotwav"}
	],
	preloads: []
};
