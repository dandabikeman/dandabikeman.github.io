...
lib.ssMetadata = [
		{name:"HolidayCard2019_LGonzalez_atlas_", frames: [[0,0,1598,1811]]},
		{name:"HolidayCard2019_LGonzalez_atlas_2", frames: [[0,0,1067,1188],[1069,0,838,671],[1069,673,506,206],[1069,881,506,206],[1069,1089,506,206]]}
];
...
(lib.CachedTexturedBitmap_54 = function() {
	this.initialize(ss["HolidayCard2019_LGonzalez_atlas_"]);
	this.gotoAndStop(0);
...
(lib.CachedTexturedBitmap_55 = function() {
	this.initialize(ss["HolidayCard2019_LGonzalez_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.HolidayCard2019LGonzalez = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(1592.75,969.6);

	this.text_1 = new cjs.Text("HAPPY CHRISTMAS", "144px 'Times New Roman'");
	this.text_1.lineHeight = 161;
	this.text_1.lineWidth = 841;
	this.text_1.parent = this;
	this.text_1.setTransform(23.65,17.15);

	this.instance = new lib.CachedTexturedBitmap_54();
	this.instance.parent = this;
	this.instance.setTransform(792.15,32.25,0.5,0.5);

	this.instance_1 = new lib.CachedTexturedBitmap_55();
	this.instance_1.parent = this;
	this.instance_1.setTransform(792.05,334.45,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.text_1},{t:this.text}]}).to({state:[{t:this.instance_1}]},49).wait(1));

	// Holiday_Message
	this.text_2 = new cjs.Text("1", "48px 'Times New Roman'");
	this.text_2.lineHeight = 55;
	this.text_2.lineWidth = 67;
	this.text_2.parent = this;
	this.text_2.setTransform(1592.65,960.35);

	this.text_3 = new cjs.Text("HAPPY CHRISTMAS", "144px 'Times New Roman'");
	this.text_3.lineHeight = 161;
	this.text_3.lineWidth = 841;
	this.text_3.parent = this;
	this.text_3.setTransform(23.55,7.9);

	this.instance_2 = new lib.CachedTexturedBitmap_56();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1172.15,20.15,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_2,p:{text:"1"}}]}).to({state:[]},1).to({state:[{t:this.instance_2},{t:this.text_3},{t:this.text_2,p:{text:"50"}}]},48).wait(1));
...
p.nominalBounds = new cjs.Rectangle(861.6,530.9,800.1999999999999,507.80000000000007);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_LGonzalez_atlas_.png?1576632777626", id:"HolidayCard2019_LGonzalez_atlas_"},
		{src:"images/HolidayCard2019_LGonzalez_atlas_2.png?1576632777626", id:"HolidayCard2019_LGonzalez_atlas_2"},
		{src:"sounds/soundwav.mp3?1576632777635", id:"soundwav"}
	],
	preloads: []
};
