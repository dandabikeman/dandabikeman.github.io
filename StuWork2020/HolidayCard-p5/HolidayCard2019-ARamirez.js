...
lib.ssMetadata = [
		{name:"HolidayCard2019_ARamirez_atlas_", frames: [[0,416,506,206],[0,0,506,206],[0,208,506,206]]}
];
...
(lib.CachedTexturedBitmap_620 = function() {
	this.initialize(ss["HolidayCard2019_ARamirez_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.HolidayCard2019ARamirez = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_39 = function() {
		playSound("meryychristmaseveryonewav");
	}
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:38.2,y:27.1,text:"Merry Christmas Everyone",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:995},0).wait(11));

	// Animation
	this.text_1 = new cjs.Text("", "12px 'TimesNewRomanPSMT'", "#CC9900");
	this.text_1.lineHeight = 15;
	this.text_1.lineWidth = 100;
	this.text_1.parent = this;
	this.text_1.setTransform(865.75,1106.85);

	this.text_2 = new cjs.Text("", "12px 'TimesNewRomanPSMT'", "#CC9900");
	this.text_2.lineHeight = 15;
	this.text_2.lineWidth = 100;
	this.text_2.parent = this;
	this.text_2.setTransform(651.8,1144.85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_2},{t:this.text_1}]}).wait(50));
...
p.nominalBounds = new cjs.Rectangle(876.2,550.1,785.5,610.1999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_ARamirez_atlas_.png?1576634734563", id:"HolidayCard2019_ARamirez_atlas_"},
		{src:"sounds/meryychristmaseveryonewav.mp3?1576634734569", id:"meryychristmaseveryonewav"}
	],
	preloads: []
};
