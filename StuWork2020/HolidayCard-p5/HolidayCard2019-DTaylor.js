...
lib.ssMetadata = [
		{name:"HolidayCard2019_DTaylor_atlas_", frames: [[0,847,873,506],[0,0,577,845],[0,1355,506,206],[0,1563,506,206],[0,1771,506,206]]}
];
...
(lib.CachedTexturedBitmap_608 = function() {
	this.initialize(ss["HolidayCard2019_DTaylor_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.CachedTexturedBitmap_615();
...
// stage content:
(lib.HolidayCard2019DTaylor = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:172.95,y:-33.25,text:"Happythanksgiving",font:"144px 'Times New Roman'",color:"#333333",lineHeight:161.45,lineWidth:1208},0).to({_off:true},11).wait(4));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_608();
	this.instance.parent = this;
	this.instance.setTransform(237.5,107.95,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({x:211.95,y:100.1},0).wait(5).to({x:187.95},0).wait(6).to({x:240.95},0).wait(5).to({x:258.7},0).wait(5).to({x:265.95},0).wait(10));

	// body
	this.instance_1 = new lib.CachedTexturedBitmap_612();
	this.instance_1.parent = this;
	this.instance_1.setTransform(154.15,139.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({x:118.9,y:129.6},0).wait(11).to({x:176.9},0).wait(10).to({x:172.9},0).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.playButton).to({_off:true},50).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(938.5,489.8,723.2,539.6000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_DTaylor_atlas_.png?1576634485116", id:"HolidayCard2019_DTaylor_atlas_"},
		{src:"sounds/untitledwav.mp3?1576634485122", id:"untitledwav"}
	],
	preloads: []
};
