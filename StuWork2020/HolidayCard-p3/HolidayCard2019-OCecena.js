...
lib.ssMetadata = [
		{name:"HolidayCard2019_OCecena_atlas_", frames: [[0,0,1280,720],[1282,0,506,206],[1282,416,506,206],[1282,208,506,206]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["HolidayCard2019_OCecena_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	// Shape
	this.instance = new lib.CachedTexturedBitmap_3353();
	this.instance.parent = this;
	this.instance.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_1 = new lib.CachedTexturedBitmap_3354();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_3355();
...
// stage content:
(lib.HolidayCard2019OCecena = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(335,293,0.788,0.7725);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_OCecena_atlas_.png?1576533840729", id:"HolidayCard2019_OCecena_atlas_"}
	],
	preloads: []
};
