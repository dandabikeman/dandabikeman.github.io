...
lib.ssMetadata = [
		{name:"HolidayCard2019_JAlfaro_atlas_", frames: [[889,0,887,1248],[0,0,887,1298],[0,1300,506,206],[889,1250,506,206],[1397,1250,506,206]]}
];
...
(lib.CachedTexturedBitmap_1372 = function() {
	this.initialize(ss["HolidayCard2019_JAlfaro_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ButtonYellow = function(mode,startPosition,loop) {
	...
	// Shape
	this.instance = new lib.CachedTexturedBitmap_1374();
	this.instance.parent = this;
	this.instance.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_1 = new lib.CachedTexturedBitmap_1375();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1.5,-1.5,0.5,0.5);

	this.instance_2 = new lib.CachedTexturedBitmap_1376();
...
// stage content:
(lib.HolidayCard2019JAlfaro = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.text).to({_off:true},1).wait(38).to({_off:false,x:320.1,y:129.05,text:"Happy Holidays!",font:"144px 'Times New Roman'",lineHeight:161.45,lineWidth:1004},0).wait(11));

	// Animation
	this.instance = new lib.CachedTexturedBitmap_1372();
	this.instance.parent = this;
	this.instance.setTransform(578.9,334.8,0.5,0.5);

	this.instance_1 = new lib.CachedTexturedBitmap_1373();
	this.instance_1.parent = this;
	this.instance_1.setTransform(578.9,334.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},5).wait(45));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HolidayCard2019_JAlfaro_atlas_.png?1576530008613", id:"HolidayCard2019_JAlfaro_atlas_"},
		{src:"sounds/HappyHolidayswav.mp3?1576530008619", id:"HappyHolidayswav"}
	],
	preloads: []
};
