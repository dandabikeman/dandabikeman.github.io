...
if (reversed == null) { reversed = false; }
	...
	this.shape_87.graphics.f("#000000").s().p("");
	this.shape_87.setTransform(380.95,53.82);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("#000000").s().p("");
	this.shape_88.setTransform(357.525,53.825);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("#000000").s().p("");
	this.shape_89.setTransform(335.6,43.45);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("#000000").s().p("");
	this.shape_90.setTransform(316.6986,53.85);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("#000000").s().p("");
	this.shape_91.setTransform(285,53.75);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#000000").s().p("");
	this.shape_92.setTransform(251.875,54.225);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("#000000").s().p("");
	this.shape_93.setTransform(229.9486,53.85);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f("#000000").s().p("");
	this.shape_94.setTransform(212.425,48.275);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("#000000").s().p("");
	this.shape_95.setTransform(190.75,53.9409);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("#000000").s().p("");
	this.shape_96.setTransform(160.6,44.3);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.f("#000000").s().p("AgUAbQgHgFgBgOQAAgIAFgIQAFgJAHgGQAIgHAGAAQAMABAHAGQAHAGAAAGQAAANgHAKQgHAJgIAFQgHAFgFAAIgBAAQgHAAgHgEg");
	this.shape_97.setTransform(113.35,65.9275);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.f("#000000").s().p("");
	this.shape_98.setTransform(100.1521,54.15);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.f("#000000").s().p("");
	this.shape_99.setTransform(77.475,54.225);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f("#000000").s().p("");
	this.shape_100.setTransform(49.775,45.725);
